...
{
    [[Benchmark new] processImageAtURL:URL iterations:iterations parallel:parallel devicePredicate:predicate inputScale:scale correct:correct revision:revisionOrNil exitAtEnd:exitAtEnd completionHandler:completionHandler];
}
