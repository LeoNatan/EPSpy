...
{
    [[Benchmark new] processImageAtURL:URL iterations:iterations parallel:parallel devicePredicate:predicate inputScale:scale correct:correct exitAtEnd:exitAtEnd completionHandler:completionHandler];
}
